# Source: https://github.com/OzgurBagci/fastbilateral/blob/master/code/fastbilateralapprox.py
import numpy as np
from scipy import signal, interpolate


def fastBilateral(image, sigmaspatial, sigmarange, samplespatial=None, samplerange=None):
    """
